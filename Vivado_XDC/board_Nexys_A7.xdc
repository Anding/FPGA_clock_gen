## This file is a general .xdc for the Nexys 4-DDR / Nexys A7-100T  (!caution! 
## To use it in a project:
## - uncomment the lines corresponding to used pins
## - rename the used ports (in each line, after get_ports) according to the top level signal names in the project
## - CARE!  top level signal names are care sensitive in xdc and must case match the VDHL declarations (AR 2022-02)
## - CARE!  not for the Nexys 4 'original' board (AR 2022-08))
